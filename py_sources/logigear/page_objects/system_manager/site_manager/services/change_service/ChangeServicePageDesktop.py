...
class ChangeServicePageDesktop(GeneralPage):
    
    def __init__(self):
        GeneralPage.__init__(self)
        
    def change_service(self, treeNode=None, service=None, serviceDesignation=None, routeDesignation=None, poeType=None, delimiter="/", clickConnect=True):
