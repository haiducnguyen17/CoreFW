...
class AdmSNMPLoggingOptionsPageDesktop(GeneralPage):

    def __init__(self):
        GeneralPage.__init__(self)
        
    def clear_snmp_logging_options(self, subFeature, checkboxes=None, selectedCheckboxes=None, clearingMethod=None, clearEntries=None, daysReminder=None, selectedDate=None, delimiter=","):
